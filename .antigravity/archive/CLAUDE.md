# CLAUDE.md — NexusDB Beginner Operating Guide

This is the bootstrap operating guide for the Claude AI assistant in **nexusdb**. It defines the simplified Zettelkasten rules and vault structure.
