...
Usage Modes:
  ...
  1. Gmail OAuth2 API Mode (Official Google Cloud Project):
     python .antigravity/automations/gmail_ingest.py --oauth --credentials credentials.json --query "label:nexus-capture"

  2. Dry Run / Mock Mode (For Demos & Tests):
     python .antigravity/automations/gmail_ingest.py --mock

  3. IMAP Mode (Using Gmail App Password):
     python .antigravity/automations/gmail_ingest.py --email "user@gmail.com" --password "app_password" --label "nexus-capture"
"""
