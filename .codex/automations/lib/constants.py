...
def get_vault_root() -> pathlib.Path:
    ...
    # Path is: .codex/automations/lib/constants.py -> parents[3] is vault root
...
class PathsModule(types.ModuleType):
    ...
    def __getattr__(self, name):
        ...
        if name == "VAULT":
            ...
            return vault / ".codex" / "reports"
        elif name == "LOGS":
            return vault / ".codex" / "logs"
        elif name == "RULES":
            return vault / ".codex" / "rules"
        elif name == "SCHEMAS":
            return vault / ".codex" / "schemas"
