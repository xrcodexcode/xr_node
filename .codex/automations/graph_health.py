...
def main():
    ...
    automations_dir = os.path.join(vault_root, ".codex", "automations")
    ...
    health_log_path = os.path.join(vault_root, ".codex", "logs", "moc-health.md")
    broken_links_report_path = os.path.join(vault_root, ".codex", "reports", "broken-links.md")
    ...
    orphan_count = 0
    orphan_path = os.path.join(vault_root, ".codex", "reports", "_orphans.md")
    ...
    invalid_tag_count = 0
    invalid_tags_path = os.path.join(vault_root, ".codex", "reports", "invalid-tags.md")
    ...
    duplicate_count = 0
    duplicate_path = os.path.join(vault_root, ".codex", "reports", "duplicate-candidates.md")
