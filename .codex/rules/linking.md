...
change_reason: "v6.0.0 — Synchronized graph reachability, MOC navigation requirements, flat NODES link constraints, and deterministic link invariants with CODEX.md."
---
...
- Audit & health reports (`.codex/reports/`)
- Templates (`.codex/templates/`)
- System files, rules, and scripts (`.codex/`)
