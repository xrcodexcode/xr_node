...
change_reason: "v6.0.0 — Synchronized tag schema with CODEX.md, source tags (yt, podcast, book, article, paper, transcript, web-clip), meta tags (moc, draft), discovery facets, and alias mappings."
---
