...
This skill enables Codex to retrieve knowledge from NexusDB with **zero local RAM overhead**, bypassing heavy local vector databases (ChromaDB) and local LLMs (Ollama).
...
4. **Step 4 — Filter by Controlled Tags (`codex/rules/tag-schema.md`)**:
