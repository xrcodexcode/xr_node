---
title: CODEX.md — NexusDB Operating Guide
...
| .codex/reports | Validation and maintenance reports | Generated reports only |
...
- Use only approved lowercase hyphenated tags from .codex/rules/tagging.md.
