---
id: c7e3f812-9b21-4f81-a83d-e4210a51982b
title: "Doing These 10 Things Alone Will Change Your Life"
...
version: 2
aliases:
  - 10 Things Alone Self-Improvement Study Notes
tags:
  - reference
  - checklist
owner_moc: "📺 YouTube Map of Content"
sources:
  - "https://www.youtube.com/watch?v=poAYEHHwZF4"
  - "01_RAW/SOURCE/Doing These 10 Things Alone Will Change Your Life.md"
related: []
schema_version: 4
---
...
```mermaid
flowchart TD
    subgraph PHASE_1 ["Phase 1: Solitude & Mental Clarity"]
        A1["1. Enjoy Solitude (0:00)<br>• Solitary walks, meals, movies<br>• Hear uninfluenced thoughts"] --> A2["2. Digital Fasting (0:22)<br>• 24h zero phone/content<br>• Build silence & boredom tolerance"]
        A2 --> A3["3. Private Ambition (1:00)<br>• Silence surrounding goals<br>• Guard execution energy"]
    end

    subgraph PHASE_2 ["Phase 2: Discipline & Internal Integrity"]
        B1["4. Daily Discomfort (1:30)<br>• Hard task before feeling ready<br>• Overcome activation energy"] --> B2["5. Keep Self-Promises (2:05)<br>• Action over intention<br>• Build empirical self-trust"]
        B2 --> B3["6. Non-Defensive Audit (2:31)<br>• Face errors without excuses<br>• Dismantle ego protection"]
    end

    subgraph PHASE_3 ["Phase 3: Sovereignty & Radical Ownership"]
        C1["7. Relational Pruning (3:02)<br>• Release toxic connections<br>• Protect internal peace"] --> C2["8. Detach from Approval (3:10)<br>• Stop explaining yourself<br>• Let outcomes speak"]
        C2 --> C3["9. Unburdened Reset (3:37)<br>• Start fresh without regret<br>• Stop repeating old loops"]
        C3 --> C4["10. Radical Ownership (4:08)<br>• No one is coming to save you<br>• 100% control of choices"]
    end

    PHASE_1 ==> PHASE_2 ==> PHASE_3
    C4 ==> SOVEREIGNTY["EMOTIONAL SOVEREIGNTY & MENTAL TOUGHNESS"]
```
