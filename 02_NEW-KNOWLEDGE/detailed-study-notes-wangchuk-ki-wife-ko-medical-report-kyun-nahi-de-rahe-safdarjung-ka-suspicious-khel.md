...
version: 1
aliases:
  - "Safdarjung Hospital Detention of Sonam Wangchuk"
  - "Jantar Mantar NEET Protest Analysis"
tags:
  - case-study
  - history
  - reference
...
```mermaid
flowchart TD
    A["NEET Paper Leak Controversy (CJP Protest)"] --> B["Sonam Wangchuk Joins Hunger Strike (19+ Days)"]
    B --> C["Massive Public & Media Visibility"]
    C --> D["Announcement of July 20 Sansad March"]
    D --> E["Delhi Police Midnight HQ Meeting (1:30 AM)"]
    E --> F["5:30 AM Covert 30-Sec Extraction"]
    F --> G["Detention at Safdarjung Hospital"]
    G --> H["Wife Files Formal Legal Refusal of Unconsented Treatment"]
```
