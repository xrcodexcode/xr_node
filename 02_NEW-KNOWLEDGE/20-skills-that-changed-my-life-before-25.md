...
owner_moc: "yt-moc"
sources:
  - "https://www.youtube.com/watch?v=hKFiQiHYvK0"
  - "[[01_RAW/SOURCE/20 Skills That Changed My Life Before 25.md]]"
related: []
---
...
```mermaid
flowchart TD
    A["Step 1: Talk to 2 new people daily — gym, mall, cafe (06:38)"] --> B["Step 2: Record yourself speaking about your day (06:58)"]
    B --> C["Step 3: Review the recording — observe how you communicate (07:04)"]
    C --> D["Step 4: Identify where you freeze, get stuck, or lose clarity (07:17)"]
    D --> E["Step 5: Fix those specific issues first — grammar comes later (07:23)"]
    E --> F["Step 6: Repeat daily — improvement compounds over time (07:23)"]
```
...
```mermaid
flowchart TD
    subgraph Career["Career & Professional Growth"]
        E["Email Mastery (03:23)"]
        C["Communication (05:29)"]
        D["Dressing (07:33)"]
        FI["First Impression (20:29)"]
        AI["AI as Employee (14:43)"]
        X["X / Build in Public (25:05)"]
        INC["Multiple Incomes (23:28)"]
    end

    subgraph Personal["Personal Development"]
        T["Travel (00:55)"]
        SP["Sports (02:07)"]
        LA["Live Alone (16:11)"]
        SH["Be Shameless (18:48)"]
        FIC["Read Fiction (17:37)"]
    end

    subgraph Health["Health & Energy"]
        F["Fitness Mindset (08:50)"]
        SL["Sleep Maxxing (13:41)"]
        CK["Learn to Cook (27:50)"]
    end

    subgraph Intellectual["Intellectual Growth"]
        J["Journaling (22:10)"]
        SS["Substack over Reels (26:27)"]
        W["Writing Well (30:21)"]
        DW["Deep Work Blocks (29:00)"]
    end

    subgraph Environment["Environment & Network"]
        BC["Big City (10:06)"]
        MP["Meet New People (12:14)"]
    end
