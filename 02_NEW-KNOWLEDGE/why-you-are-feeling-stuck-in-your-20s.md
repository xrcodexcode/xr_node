...
version: 2
aliases:
  - Why You Are Feeling STUCK In Your 20s Study Guide
tags:
  - case-study
  - decision
  - example
...
related:
  - "[[NODES/unemployment-optionality-paradox|Unemployment Optionality Paradox]]"
  - "[[NODES/poison-of-optionality|Poison of Optionality]]"
  - "[[NODES/hell-yes-or-no-filter|Hell Yes or No Filter]]"
  - "[[NODES/two-way-vs-one-way-doors|Two-Way vs One-Way Doors]]"
  - "[[NODES/keep-moving-heuristic|Keep Moving Heuristic]]"
schema_version: 4
---
...
```mermaid
flowchart TD
    A["Information Abundance & Safety Net (00:00, 02:52)"] --> B["Social Media Amplification of Paths (06:46)"]
    B --> C["The Poison of Optionality (08:20, 09:19)"]
    C --> D["Cognitive Fog & Decision Paralysis (07:46, 08:51)"]
    
    D --> E["Step 1: Enforce 'Hell Yes or No' Filter (11:04)"]
    E --> F["Step 2: Classify Decisions (Two-Way vs One-Way Doors) (13:49)"]
    F --> G["Step 3: Execute Two-Way Doors Quickly (14:20)"]
    G --> H["Step 4: Heuristic of Constant Motion ('Keep Moving') (16:13, 19:00)"]
    H --> I["Dynamic Course Correction & Career Clarity (16:13)"]
```
