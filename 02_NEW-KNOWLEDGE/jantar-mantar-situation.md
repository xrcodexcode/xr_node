...
version: 1
aliases:
  - "Jantar Mantar Situation! Detailed Study Notes"
tags:
  - reference
  - case-study
owner_moc: yt-moc
sources:
  - "01_RAW/SOURCE/Jantar Mantar Situation!.md"
related: []
schema_version: 4
---
...
```mermaid
flowchart TD
    A["NEET Paper Leak & Systemic Failures (3:50)"] --> B["Peaceful Sit-in Protests at Jantar Mantar (0:04)"]
    B --> C["Mainstream Media Blackout & State Indifference (6:07)"]
    C --> D["July 20th Police Crackdown & Baton Charge (5:09, 14:53)"]
    D --> E["Protest Aggression & Cross-State Influx (11:17, 13:02)"]
    E --> F["Demand for Ministerial Resignation & Systemic Reform (8:04, 13:33)"]
```
