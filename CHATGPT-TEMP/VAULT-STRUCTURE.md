...
This file is a structural map only. All governance, enforcement, confidence thresholds, and decision rules live in GEMINI.md → .antigravity/rules/core/governance.md. Do not treat this file as authoritative for AI behavior.
...
.antigravity/
    ...
    automations/
        ...
        01_RAW/
        constants/
        semantic_linker_hook/
        check_vault.py
        concept_id_migrator.py
        decay_scheduler.py
        demote_raw.py
    ...
    logs/
        audit-log.md
        concept-id-migration-2026-07-18.json
        moc-curation.json
        moc-health.md
    ...
    reports/
        ...
        invalid-tags.md
        link-suggestions.md
        moc-split-candidates.md
        pipeline_run.md
        promotion-candidates.md
        semantic_link_report.md
        vault-summary.md
    schemas/
