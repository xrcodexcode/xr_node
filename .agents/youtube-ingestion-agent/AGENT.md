...
description: Specialized agent for ingesting YouTube transcripts into NexusDB as a single high-fidelity study note while enforcing the YouTube Knowledge Ingestion skill, validation pipeline, and promotion workflow.
