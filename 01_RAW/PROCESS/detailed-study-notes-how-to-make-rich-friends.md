...
confidence: 90
version: 1
aliases: ["How to Make Rich Friends"]
tags: ["yt", "transcript", "self-improvement", "business", "strategy"]
owner_moc: "Self Improvement MOC"
sources: ["[[How to Make Rich Friends]]"]
related: []
schema_version: 4
---
...
graph TD
    ...
    subgraph TRIBE Framework
    T_desc["Identify individuals with intentionality (from hit list). Start with folks closer to your level for reps."]
    R_desc["Realize you don't need any ONE person. Make a wide list (12-100 people). Nobody is the gatekeeper of your dreams."]
    I_desc["Invest by showing up. E.g., Jason Gaynard flying 2,000 miles just to stand in line at Dan's book launch."]
    B_desc["Build a platform (dinners, hikes, newsletter). Bring complimentary people together (e.g., lawyer + accountant). You become the hub."]
    E_desc["Edit your feed: Follow your targets and relentlessly mute/unfollow distractions ('ding-dongs')."]
