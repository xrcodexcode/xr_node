...
version: 1
aliases:
  - "Modi's WAR Against Indians | What happened at Jantar Mantar? | Dhruv Rathee Detailed Study Notes"
tags:
  - reference
  - case-study
owner_moc: yt-moc
sources:
  - "01_RAW/SOURCE/Modi's WAR Against Indians  What happened at Jantar Mantar  Dhruv Rathee.md"
  - "https://www.youtube.com/watch?v=l-6Pm-112io"
related: []
schema_version: 4
---
...
```mermaid
flowchart TD
    subgraph Phase1 ["Phase 1: Peaceful Sit-In & Escalation (20 June - 17 July 2026)"]
        A1["20 June: CJP Sit-in begins at Jantar Mantar (03:11)"] --> A2["28 June: Sonam Wangchuk joins Indefinite Fast (03:40)"]
        A2 --> A3["17 July: Sudden Removal of Police Commissioner Satish Golcha (04:25)"]
        A3 --> A4["IPS Anurag Kumar (IB Special Director) takes charge (04:49)"]
    end

    subgraph Phase2 ["Phase 2: Stage Clearing & Pre-March Isolation (18 July - 19 July 2026)"]
        B1["18 July (06:30 AM): Sonam Wangchuk forcibly taken to Safdarjung Hospital (05:00)"] --> B2["19 July (07:00 PM): BNSS Section 163 imposed by DCP New Delhi (05:51)"]
        B2 --> B3["10-ft Welded Barricades + Jammers + Internet Shutdown across 150 sites (06:08)"]
        B3 --> B4["20 July (04:40 AM): Planted damaged vehicles & stone truck discovered; Security check posts removed (00:23)"]
    end

    subgraph Phase3 ["Phase 3: Crackdown on March & Resistance (20 July 2026)"]
        C1["09:00 AM: 5 Key Metro Stations Closed; Students Jump Barriers (06:43)"] --> C2["10:40 AM: Pretext Distraction Negotiations with JP Nadda (13:55)"]
        C2 --> C3["10:51 AM: Mandi House Lathi-Charge & Tear Gas on Sansad Marg (07:37)"]
        C3 --> C4["01:30 PM - 03:30 PM: Parliament Lockdown, Civilian Assaults & Jantar Mantar Stage Demolition (09:40)"]
        C4 --> C5["Evening: Protesters Re-occupy Jantar Mantar & Nationwide Spillovers (15:27)"]
    end
...
```mermaid
flowchart TD
    subgraph Setup ["State Containment Strategy (05:51 - 06:30)"]
        S1["BNSS Section 163 Imposed (Gatherings >5 Banned)"]
        S2["10-Foot 3-Layer Welded Barricades"]
        S3["Communication Jammers Installed"]
        S4["Internet Disabled at 150 Central Delhi Sites"]
    end

    subgraph Operation ["March Suppression Execution (06:43 - 14:00)"]
        O1["Metro Shutdown (5 Stations)"] --> O2["Crowd Bottleneck & Escalation"]
        O2 --> O3["Lathi-Charge & Tear Gas Firing"]
        O3 --> O4["Police Stone Pelting & Officer Identification Removal"]
    end

    subgraph Pretext ["Leadership Neutralization Protocol (13:50 - 14:49)"]
        P1["CJP Spokesperson Saurav Das Detained at 10:40 AM"] --> P2["Delayed Meeting Offers (DM -> Union Sec -> MoS -> Nadda)"]
        P2 --> P3["2-Hour Wait for 10-Minute Non-Committal Meeting"]
        P3 --> P4["Protest Leadership Isolated During Peak Force Deployment"]
    end
...
```mermaid
flowchart LR
    Delhi["Delhi: Central Hub (Jantar Mantar / CP / Parliament)"] --> UP1["Lucknow: Lucknow University Students Arrested"]
    Delhi --> UP2["Allahabad: Student Solidarity March"]
    Delhi --> GUJ["Ahmedabad: Protests & Student Detentions"]
    Delhi --> WB["Kolkata: University Student Rallies"]
    Delhi --> MAH["Mumbai: Demonstrations at Chaitya Bhoomi"]
    Delhi --> KAR["Bangalore: Student Rallies"]
    Delhi --> GOA["Goa: Youth Solidarity Gatherings"]
    Delhi --> ARU["Arunachal Pradesh: Thousands March in Solidarity"]
```
