...
version: 1
aliases:
  - "Tania Lombrozo TEDx Talk Study Notes"
  - "Learning by Thinking Exhaustive Study Notes"
tags:
  - reference
  - example
owner_moc: "General MOC"
sources:
  - "[[01_RAW/SOURCE/How you can learn in a world of information overload  Tania Lombrozo  TEDxNewEngland.md]]"
related: []
schema_version: 4
---
...
```mermaid
flowchart TD
    A["Faced with a Learning Problem"] --> B{"Initial Learning Strategy"}
    B -->|"Default Strategy: Look Outward Immediately"| C["Query AI / Search Internet (01:37)"]
    C --> D["Information Overwhelm & Cognitive Saturation (01:51)"]
    D --> E["Illusion of Understanding & Fragmented Retention"]
    
    B -->|"Recommended Strategy: Look Inward First"| F["Learning by Thinking (00:51)"]
    F --> G["Tap Internal Memory & Skills Repository (02:23)"]
    G --> H["Transform & Combine Internal Representations (04:47)"]
    H --> I["Generate Targeted 'Information Shopping List' (12:47)"]
    I --> J["Surgically Search External Sources / AI (13:03)"]
```
...
```mermaid
flowchart TD
    SubGraph1["1980s Cognitive Science Study (06:37)"]
    A["Identical Textbooks & Materials Supplied"] --> B{"Student Processing Method"}
    B -->|"Passive Reading / Highlight Only"| C["Low Comprehension & Poor Knowledge Transfer"]
    B -->|"Self-Explanation Strategy (07:23)"| D["Active Internal Questioning & Self-Answering"]
    D --> E["Self-Explanation Effect (08:03)"]
    E --> F["Deep Conceptual Understanding & Broad Knowledge Transfer"]
```
...
```mermaid
flowchart TD
    A["Attempt Step-by-Step Self-Explanation (11:06)"] --> B["Hit Reasoning Bottleneck / Draw Blank (11:26)"]
    B --> C["Expose Illusion of Explanatory Depth (11:57)"]
    C --> D["Identify Precise Missing Knowledge Gaps (12:14)"]
    D --> E["Construct Targeted 'Information Shopping List' (12:47)"]
    E --> F["Execute Efficient External Research / Query AI (13:03)"]
```
